...
Boot::Boot(const Boot &el) : Uczestnik(el)
{
    inteligencja=el.inteligencja;
}

Boot::Boot(int lap) : Uczestnik(lap)
{
    inteligencja=1;
}
...
void Boot::setInt(int intel){
    inteligencja=intel;
}

Point Boot::jedz(bool l, bool p, bool a, bool b, bool su, bool sd, float &vg, bool flaga, float &ang){   
...
void Boot::decydujGdzieIJak(bool &l, bool &p, bool &a, bool &b, bool &su, bool &sd){
...
void Boot::setPopPol(Point a){
    popPol=a;
}

void Boot::setPopPol2(Point a){
    popPol2=a;
}
