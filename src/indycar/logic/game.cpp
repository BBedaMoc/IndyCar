...
namespace indycar {
    namespace logic {
        ...
        void Game::dodaUczestnika(Participant* pom) {
            uczestnicy.push_back(pom);
        }


        void Game::ladujAuta(std::string param) {
            std::ifstream wej;
        ...
        void Game::ladujCfg(std::string path) {
            std::ifstream wej;
            wej.open(path.c_str());
            wej.seekg(0, wej.beg);
            if (wej.good()) {
        ...
        void Game::ladujTrasy(std::string path) {
            std::ifstream wej;
            wej.open(path.c_str());
            wej.seekg(0, wej.beg);
            if (wej.good()) {
        ...
        std::vector <Car*> Game::getRefAuta() {
            return refAuta;
        }

        std::vector <Track*> Game::getRefTrasy() {
            return refTrasy;
        }
        ...
        void Game::nowaGra() {
            ...
            for (int i = int(uczestnicy.size()) - 1; i >= 0; i--) {
                ...
                if (i <= u) {
                    dynamic_cast <Bot*> (uczestnicy[i])->setPopPol(Point((5 + 4 * (i % 2)) * (resX - 260) / 14, resY * 4 / 5 - (int(uczestnicy.size()) - 1 - i) * 100));
                    dynamic_cast <Bot*> (uczestnicy[i])->setPopPol2(Point((5 + 4 * (i % 2)) * (resX - 260) / 14, resY * 4 / 5 - (int(uczestnicy.size()) - 1 - i) * 100));
        ...
        void Game::czyDacEvent(Participant* dr) {
        ...
        std::vector <Participant*> Game::getUczestnicy() {
            return uczestnicy;
        }

        std::vector <Obstacle*> Game::getLosowePrz() {
            return losowePrz;
        }

        void Game::aktPozycjeWT() {
            for (int i = 0; i<int(uczestnicy.size()); i++) {
        ...
        void Game::losowyEfekt(Participant* gr) {
        ...
        void Game::aktPosEv(float angle, float poX, float poY, Point srObr) {
            std::vector <int> doUs;
            for (int i = 0; i<int(losowePrz.size()); i++) {
        ...
        int Game::ktoraTxEv(Obstacle* el) {
            int a = 0;
            for (int i = 0; i < 5; i++) {
        ...
        void Game::usunVektor(std::vector <Obstacle*>& el) {
        ...
        void Game::krokPodstawowy(bool u, bool d, bool l, bool p, bool su, bool sd, int aktObserUcz) {
            Point delta;
            float vgl = 0;
            float angl = 0;
            float katN = 0;
            ...
            for (int i = 0; i<int(uczestnicy.size()); i++) {
                ...
                Bot* pz = dynamic_cast <Bot*> (uczestnicy[i]);
                float x = 0;
                if (pz) {
                    x = pz->zadPol.x;
                }
        ...
        void Game::pozycjeZadane() {
            for (int i = 0; i<int(uczestnicy.size()); i++) {
                Bot* pz1 = dynamic_cast <Bot*> (uczestnicy[i]);
