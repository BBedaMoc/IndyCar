...
namespace indycar {
    namespace logic {
        ...
        Player::Player(const Player& el) : Participant(el)
        {

        }

        Player::Player(int lap) : Participant(lap)
        {
        ...
        Point Player::jedz(bool l, bool p, bool a, bool b, bool su, bool sd, float& vg, bool flaga, float& ang) {
            if (koniecWys) {
                b = true;
                a = false;
            }
